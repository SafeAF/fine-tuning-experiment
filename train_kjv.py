...
# Use regex to remove verse numbers and other metadata like "Genesis 1:1"
cleaned_text = re.sub(r'\b\w+\s\d+:\d+\b', '', text)
...
tokenized_text = tokenizer(cleaned_text, return_tensors='pt', padding=True, truncation=True, max_length=512)
...
training_args = TrainingArguments(
    output_dir="./results",
    num_train_epochs=5,  # Increased to reduce overfitting
...
tokenizer.save_pretrained("./fine-tuned-kjv-model")
